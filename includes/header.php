...
<nav class="navbar">
  <div class="container nav-inner">
    <a href="<?= e(PUBLIC_URL) ?>index.php" class="logo-link">
      <img src="<?= e(PUBLIC_URL) ?>assets/images/logo.png" alt="ElderCare logo" class="logo-img">
      <span class="logo-text">ElderCare</span>
    </a>
    <div class="nav-links">
